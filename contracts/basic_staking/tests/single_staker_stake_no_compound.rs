...
fn single_staker_stake_no_compound(
    ...
    snip20::ExecuteMsg::Send {
        ...
        amount: stake_amount - Uint128::one(),
        msg: Some(
    ...
    .unwrap()
    {
        basic_staking::QueryAnswer::Balance {
            ...
            assert_eq!(staked, stake_amount - Uint128::one(), "Post-Stake Balance");
        }
        _ => {
            panic!("Staking balance query failed");
        }
    ...
    // Claim rewards
    println!("Staking 1 utkn to test claim on stake");
    snip20::ExecuteMsg::Send {
        recipient: basic_staking.address.to_string().clone(),
        recipient_code_hash: None,
        amount: Uint128::one(),
...
macro_rules! single_staker_stake_no_compound {
    ($($name:ident: $value:expr,)*) => {
        $(
            ...
            fn $name() {
                ...
                single_staker_stake_no_compound(
                    stake_amount,
                    unbond_period,
                    reward_amount,
                    reward_start,
...
single_staker_stake_no_compound! {
    /*
    single_staker_stake_no_compound_0: (
    ...
    */
    single_staker_stake_no_compound_1: (
        Uint128::new(100),
        Uint128::new(100),
        Uint128::new(1000),
        Uint128::new(0),
    ...
    single_staker_stake_no_compound_2: (
        Uint128::new(1000),
        Uint128::new(100),
        Uint128::new(300),
        Uint128::new(0),
    ...
    single_staker_stake_no_compound_3: (
        Uint128::new(10),
        Uint128::new(100),
        Uint128::new(50000),
        Uint128::new(0),
    ...
    single_staker_stake_no_compound_4: (
        Uint128::new(1234567),
        Uint128::new(10000),
        Uint128::new(500),
        Uint128::new(0),
    ...
    single_staker_stake_no_compound_5: (
