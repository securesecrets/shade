...
use shade_protocol::contract_interfaces::{snip20::Snip20Asset, treasury::rewards_emission};
...
pub fn assets_r<S: Storage>(storage: &S) -> ReadonlySingleton<S, Vec<HumanAddr>> {
