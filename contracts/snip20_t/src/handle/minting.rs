...
use shade_protocol::contract_interfaces::snip20_test::manager::{Admin, Balance, CoinInfo, Config, Minters, ReceiverHash, TotalSupply};
use shade_protocol::contract_interfaces::snip20_test::transaction_history::{store_burn, store_mint};
