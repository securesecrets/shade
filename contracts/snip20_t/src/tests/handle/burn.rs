...
use shade_protocol::contract_interfaces::snip20_test::{HandleMsg, InitConfig, InitialBalance};
use shade_protocol::contract_interfaces::snip20_test::batch::BurnFromAction;
use shade_protocol::contract_interfaces::snip20_test::manager::{Balance, TotalSupply};
