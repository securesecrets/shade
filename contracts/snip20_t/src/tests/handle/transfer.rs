...
use shade_protocol::contract_interfaces::snip20_test::{HandleMsg, InitialBalance, QueryMsg, QueryAnswer};
use shade_protocol::contract_interfaces::snip20_test::manager::Balance;
