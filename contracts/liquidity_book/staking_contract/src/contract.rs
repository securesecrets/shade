use shade_protocol::{
    c_std::{entry_point, Attribute, Binary, Deps, DepsMut, Env, MessageInfo, Response, StdResult},
    contract_interfaces::liquidity_book::lb_libraries::viewing_keys::{
        register_receive,
        set_viewing_key_msg,
    },
    liquidity_book::staking::{EpochInfo, ExecuteMsg, InstantiateMsg, QueryMsg, State},
